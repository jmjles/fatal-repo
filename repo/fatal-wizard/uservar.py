...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR red][B]Fatal[/B][/COLOR]Wizard'
BUILDERNAME = 'FatalWizard'
EXCLUDES = [ADDON_ID, 'repository.openwizard']
# Text File with build info in it. Please read https://github.com/a4k-openproject/plugin.program.openwizard/wiki/Installing-Builds
BUILDFILE = 'http://raw.githubusercontent.com/jmjles/fatal-build/main/fatal-build.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Fatal[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
